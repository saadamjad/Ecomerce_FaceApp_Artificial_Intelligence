      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
        ...
        >
          ...
          <View style={{ alignSelf: "center", width: "93%", flex: 1 }}>
            ...
            <View
              style={{ flexDirection: "row", marginTop: 10, paddingLeft: 2 }}
            >
              <View
                style={{
                  height: 50,
            ...
            <Text
              style={{ marginTop: 10, color: "#334d5c", fontWeight: "500" }}
            >
              Sizes:
            </Text>
            <View style={{ flexDirection: "row" }}>
              ...
              <Text
                style={{ marginTop: 10, color: "#464646", marginRight: 65 }}
              >
                5 Lorem
              </Text>
              <Text
              ...
              <Text
                style={{ marginTop: 10, color: "#464646", marginRight: 15 }}
              >
                5 Lorem
              </Text>
            </View>
            ...
            <Text
              style={{ color: "#1f425e", fontSize: 15, paddingVertical: 10 }}
            >
              Related
            </Text>
